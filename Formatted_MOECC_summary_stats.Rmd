...
```{r echo=FALSE}
x<-read.csv("C:\\Users\\adminuser\\Desktop\\EVERYTHING THOMAS\\MOECC Alagae project\\SC_Ontario+Algonqiun+Algoma_Future_clim.csv")
```
...
```{r}
#RCP2.6
x1 <- x[, c(1, 9:56, 249:260, 633:644, 969:980, 1305:1316, 1689:1700, 2073:2084, 2457:2468,
...
write.csv (x5, file = "algalprecip_boxplot_data.csv",row.names=FALSE)
```

#### Formatting data and calculating some summary stats
```{r}

x1 <- x5 # "x5" would be "x2" if you used method 1
